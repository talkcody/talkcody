...
const zh: LocaleDefinition = {
  ...
  Chat: {
    ...
    autoGitCommit: {
      title: '自动 Git 提交',
      description: '启用后，任务完成后将自动提交代码变更',
      enabled: '已启用',
      disabled: '已禁用',
      enabledTooltip: '自动提交：任务完成后 AI 将自动生成提交信息并提交变更',
      disabledTooltip: '手动提交：在需要时通过 Git 面板手动提交',
      toggleFailed: '更新自动 Git 提交设置失败',
    },
    autoCheckFinish: {
      title: '自动检查完成',
      description: '启用后，AI 将验证任务是否真正完成，如未完成将建议后续步骤',
      enabled: '已启用',
      disabled: '已禁用',
      enabledTooltip: '自动检查：Git 提交后 AI 将验证任务完成度并在需要时继续',
      disabledTooltip: '手动验证：由你决定任务何时完成',
      toggleFailed: '更新自动检查完成设置失败',
    },
    outputFormat: {
      title: '输出格式',
  ...
  Settings: {
    ...
    models: {
      ...
      selectModel: '选择模型',
      orderedRetryHint: '如果当前模型在返回内容前请求失败，TalkCody 会按此顺序自动重试下一个模型。',
      addFallbackModel: '添加备用模型',
      noFallbackModels: '当前未配置备用模型；在您添加覆盖项之前，将继续使用默认行为。',
    ...
    remoteControl: {
      ...
      wechat: {
        title: '微信远程控制',
        description: '通过 iLink 从个人微信私聊控制 TalkCody',
        enabled: '启用微信远程控制',
        baseUrlLabel: 'iLink Base URL',
        baseUrlPlaceholder: 'https://ilinkai.weixin.qq.com',
        allowedUserIdsLabel: '允许的用户 ID',
        allowedUserIdsPlaceholder: '逗号分隔的用户 ID（可选）',
        pollTimeoutLabel: '轮询超时（毫秒）',
        pollTimeoutPlaceholder: '35000',
        pollTimeoutHint: '推荐 10000-60000 毫秒，可填写 5000-120000 毫秒。',
        connect: '连接微信',
        reconnect: '重新连接微信',
        disconnect: '断开连接',
        statusIdle: '微信尚未连接。',
        ...
        statusConnected: '微信已连接。',
        statusExpired: '二维码已过期，请刷新后重新扫码。',
        qrHint: '请使用手机微信扫码。仅支持个人私聊。',
        personalOnlyHint: '仅支持个人私聊，不支持群聊。',
        contextHint: '回复依赖最近的微信 context token，不支持无上下文的主动冷启动发送。',
        errors: {
          baseUrlMissing: '启用后需要填写 WeChat base URL',
          pollTimeoutRange: '微信轮询超时必须在 5000 到 120000 毫秒之间',
        },
      },
    },
    shortcuts: {
  ...
  Agents: {
    ...
    localImport: {
      title: '从本地目录导入 Agent',
      description: '选择包含 Agent Markdown 文件的本地目录',
      urlLabel: '',
      urlPlaceholder: '',
      urlHint: '',
      urlRequired: '',
  ...
  Skills: {
    ...
    localImport: {
      title: '从本地目录导入技能',
      description: '选择包含单个技能或多个技能文件夹的本地目录',
      urlLabel: '',
      urlPlaceholder: '',
      urlHint: '',
      urlRequired: '',
  ...
  Tracing: {
    ...
    transportMetricsTitle: 'OpenAI 订阅传输统计',
    websocketTurnCountLabel: 'WebSocket 轮次',
    incrementalTurnCountLabel: '增量轮次',
    baselineTurnCountLabel: '基线轮次',
    httpFallbackCountLabel: 'HTTP 回退轮次',
    spansTitle: 'Span 列表',
    eventsTitle: '事件',
    attributesLabel: '属性',
    startedAtLabel: '开始时间',
