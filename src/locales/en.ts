...
const en: LocaleDefinition = {
  ...
  Settings: {
    ...
    s3Sync: {
      title: 'S3 Sync',
      description: 'Back up sessions and attachments to an S3-compatible storage.',
      enabled: 'Enable S3 Sync',
      enabledHint: 'When enabled, you can back up and restore via your S3 bucket.',
      warning:
        'Your S3 credentials are stored locally. Only use on trusted devices and prefer least-privilege keys.',
      endpoint: 'Endpoint',
      endpointPlaceholder: 'https://s3.amazonaws.com (or your R2/MinIO endpoint)',
      region: 'Region',
      bucket: 'Bucket',
      ...
      sessionTokenPlaceholder: 'Temporary credentials token',
      sessionTokenHint: 'Leave empty unless you use STS temporary credentials.',
      pathStyle: 'Path-Style Addressing',
      pathStyleHint: 'Enable for MinIO or some S3-compatible providers.',
      namespace: 'Sync Namespace (Optional)',
      namespacePlaceholder: 'shared-team (same on multiple devices)',
      namespaceHint:
        'Leave empty to use this device ID (recommended). Set the same namespace on multiple devices to share backups.',
      keyPrefix: 'Key Prefix',
      testConnection: 'Test',
      backupNow: 'Backup Now',
      restore: 'Restore (Restart)',
      save: 'Save',
      saved: 'S3 sync settings saved',
      saveFailed: 'Failed to save S3 sync settings',
      testSuccess: 'S3 connection test successful',
      testFailed: 'S3 connection test failed',
      backupSuccess: 'Backup uploaded to S3',
      backupFailed: 'Backup failed',
      restoreScheduled: 'Restore downloaded. Restart TalkCody to apply.',
      restoreScheduleFailed: 'Failed to download restore archive',
      lastBackupAt: (time) => `Last backup: ${time}`,
      lastBackupNone: 'No backups yet',
      errors: {
        invalidConfig: 'Please fill in all required fields',
        notEnabled: 'S3 Sync is not enabled',
      },
    },
    apiKeys: {
