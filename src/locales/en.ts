...
const en: LocaleDefinition = {
  ...
  Settings: {
    ...
    webdav: {
      ...
      description:
        'Configure a WebDAV server to sync your data. Supports Jianguoyun, Nextcloud, and other cloud storage services that support the WebDAV protocol.',
      status: {
        title: 'Sync Status',
        configured: 'Configured',
        status: 'Status',
      ...
      serverUrlHint:
        'Example: Jianguoyun https://dav.jianguoyun.com/dav/, Nextcloud https://your-domain.com/remote.php/webdav/',
      username: 'Username',
      usernamePlaceholder: 'your-email@example.com',
      usernameHint: 'Usually your email address or username',
      password: 'Password',
      passwordPlaceholder: 'App password',
      passwordHint:
        'Recommended to use an app password instead of your main account password. Jianguoyun users should generate an app password in account security options.',
      syncPath: 'Sync Path',
      syncPathPlaceholder: '/talkcody',
      syncPathHint:
        'Storage path on the WebDAV server, starting with /. Ensure write permission for this path.',
      autoSync: 'Auto Sync',
      autoSyncDescription: 'Enable periodic automatic data sync',
      ...
      messages: {
        testSuccess:
          'Connection test successful! WebDAV server is accessible and sync path exists.',
        testSuccessPathNotExists:
          'Connection successful! Sync path does not exist and will be created automatically when saving configuration.',
        testFailed: (error: string) => `Connection test failed: ${error}`,
        saveSuccess: 'Configuration saved successfully! WebDAV sync is enabled.',
        saveFailed: (error: string) => `Failed to save configuration: ${error}`,
        clearSuccess: 'Configuration cleared.',
        clearFailed: (error: string) => `Failed to clear configuration: ${error}`,
        syncSuccess: 'Sync completed!',
        syncFailed: (error: string) => `Sync failed: ${error}`,
        connectFailed: (error: string) => `Connection failed: ${error}`,
        createPathFailed: (error: string) => `Failed to create sync directory: ${error}`,
      },
    },
