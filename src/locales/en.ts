...
const en: LocaleDefinition = {
  ...
  Chat: {
    ...
    autoGitCommit: {
      ...
      description: 'When enabled, changes will be committed automatically after a task completes',
      enabled: 'Enabled',
      disabled: 'Disabled',
      enabledTooltip:
        'Auto-commit: AI will commit changes with a generated message when the task finishes',
      disabledTooltip: 'Manual commit: use the git panel to commit when you are ready',
  ...
  Settings: {
    ...
    remoteControl: {
      ...
      wechat: {
        title: 'WeChat Remote Control',
        description: 'Control TalkCody from personal WeChat direct messages via iLink',
        enabled: 'Enable WeChat Remote Control',
        baseUrlLabel: 'iLink Base URL',
        baseUrlPlaceholder: 'https://ilinkai.weixin.qq.com',
        allowedUserIdsLabel: 'Allowed User IDs',
        allowedUserIdsPlaceholder: 'Comma-separated user ids (optional)',
        pollTimeoutLabel: 'Polling Timeout (ms)',
        pollTimeoutPlaceholder: '35000',
        pollTimeoutHint: 'Recommended 10000-60000 ms. Accepts 5000-120000 ms.',
        connect: 'Connect WeChat',
        reconnect: 'Reconnect WeChat',
        disconnect: 'Disconnect',
        statusIdle: 'WeChat is not connected.',
        statusWaiting: 'Waiting for QR scan...',
        statusScanned: 'QR scanned. Please confirm on phone.',
        statusConnected: 'WeChat connected.',
        statusExpired: 'QR expired. Please refresh and scan again.',
        qrHint: 'Scan with WeChat on your phone. Personal chats only.',
        personalOnlyHint: 'Only direct personal chats are supported. Group chats are ignored.',
        contextHint:
          'Replies depend on a recent WeChat context token. Proactive cold-start sends are not supported.',
        errors: {
          baseUrlMissing: 'WeChat base URL is required when enabled',
          pollTimeoutRange: 'WeChat polling timeout must be between 5000 and 120000 ms',
        },
      },
    },
    shortcuts: {
  ...
  Agents: {
    ...
    localImport: {
      title: 'Import Agents from Local Directory',
      description: 'Select a local directory containing agent markdown files',
      urlLabel: '',
      urlPlaceholder: '',
      urlHint: '',
      urlRequired: '',
      ...
      invalidUrl: '',
      networkError: 'Failed to scan the selected directory.',
      imported: 'imported',
      failed: 'failed',
      import: 'Import',
      close: 'Close',
  ...
  Skills: {
    ...
    localImport: {
      title: 'Import Skills from Local Directory',
      description: 'Select a local directory containing one skill or multiple skill folders',
      urlLabel: '',
      urlPlaceholder: '',
      urlHint: '',
      urlRequired: '',
      scanning: 'Scanning directory...',
      foundSkills: (count: number) => `Found ${count} skill${count !== 1 ? 's' : ''}`,
      noSkillsFound: 'No valid skills found in the selected directory',
      invalidUrl: '',
      networkError: 'Failed to scan the selected directory.',
      importing: 'Importing skills...',
      importSuccess: (count: number) =>
