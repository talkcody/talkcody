...
- Use [Skills](../features/skills) to叠加 specific domain capabilities, allowing the same agent to quickly switch between different scenarios.
...
### 5. Instant Feedback: LSP + Terminal

- Enable [LSP](../features/lsp) to get instant diagnostics and shorten feedback loops.
...
### 4. Use LSP + Tests to Form a Closed Loop

- LSP finds issues first, tests validate logic; these two form a quality closed loop.
