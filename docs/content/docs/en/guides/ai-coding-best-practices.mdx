...
### 4. Use Tests to Form a Closed Loop

- Tests validate logic and form a quality closed loop.
...
- **Efficiency**: Plan Mode planning + precise tool positioning + Worktree parallelism + Lint instant feedback
