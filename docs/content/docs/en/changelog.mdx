...
- **Keep Awake Functionality**: Improved overall keep awake functionality
- **Whats New Dialog**: Enhanced with link support for better user experience

### Fixed

- Fixed unknown command bug
- Fixed compact command issues
- Fixed Rust warnings
